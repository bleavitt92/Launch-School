...
def tf(term, document)
  ...
  # occurances
  # splits the document into an array of words (determine words by separating through white space and dashes). Then counts how many times the term occurs
end
...
def idf(term, documents)
  ...
  # puts "number of docs with term = #{number_of_documents_with_term}"
